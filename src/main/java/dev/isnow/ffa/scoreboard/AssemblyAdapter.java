...
public class AssemblyAdapter implements AssembleAdapter {
    ...
    public List<String> getLines(Player player) {
        final PlayerData data = PlayerDataManager.get(player.getUniqueId());
        final List<String> lines = TaklyFFA.INSTANCE.configManager.scoreboard.getStringList("scoreboard-lines");
